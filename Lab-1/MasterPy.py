...
while list(yourguess) != secret:
    ...
    # (this will have 4 elements when the lists match exactly)
    correctCount = sum(speg == gpeg for speg, gpeg in comparingList)
    ...
    print("Number of correct letter is ", correctCount)
    print("Number of unused letters is ", sum(fewestLetters) - correctCount)
